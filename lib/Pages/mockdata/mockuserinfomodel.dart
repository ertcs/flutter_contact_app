String isJsonString(var postalcode) {
  String postalStringCode;
  if (postalcode is String) {
    postalStringCode = postalcode;
  }
  if (postalcode is int) {
    postalStringCode = postalcode.toString();
  }
  return postalStringCode;
}
...
class Location {
  ...
  Location.fromJson(Map<String, dynamic> json) {
    ...
    postcode = isJsonString(json['postcode']);
